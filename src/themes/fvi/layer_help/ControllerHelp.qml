...
FocusScope {
  id: root
  property string buttonText1: "Cancel/Back"
  property string buttonText2: "Accept/Select"
  ...
  property string buttonText4: "Main menu"
    ...
    LinearGradient {
      ...
      Item {
        ...
        Item {
          ...
          Text {
            id: txt1
            text: "<b>" + api.keys.accept[0].name() + "</b> (" + buttonText2 + ")" + " - " + "<b>" + api.keys.cancel[0].name() + "</b> (" + buttonText1 + ")" + " - " + "<b>" + api.keys.menu[0].name() + "</b> (" + buttonText4 + ")" 
            color: "white"
        ...
        Item {
          ...
          Text {
            id: txt5
            text: "Copyright \u00a9 2020 Team Forbidden LLC."
            color: "white"
            font.pixelSize: vpx(14)
            font.family: bodyFont.name
          }
