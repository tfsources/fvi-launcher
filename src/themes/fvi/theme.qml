...
FocusScope {
  ...
  FontLoader { id: titleFont; source: "fonts/NotoSans-Black.ttf" }
  FontLoader { id: subtitleFont; source: "fonts/NotoSans-Condensed.ttf" }
  FontLoader { id: bodyFont; source: "fonts/NotoSans-Medium.ttf" }
  ...
  property string themeFVI: "#E98B89"
  property string themeColour: themeFVI
  ...
  SoundEffect {
      id: navSound
      source: "assets/audio/navsound.wav"
      volume: 1.0
  }

  SoundEffect {
      id: menuIntroSound
      source: "assets/audio/menuintrosound.wav"
      volume: 1.0
  }

  SoundEffect {
      id: toggleSound
      source: "assets/audio/togglesound.wav"
      volume: 1.0
  }
